...
console.log('EXERCÍCIO 01:', !true, !false);
...
const lionIncludeInArray = animals.includes('leão');

if (!lionIncludeInArray) {
  console.log('EXERCÍCIO 02: Leão não existe no array animals.');
} else {
  console.log('EXERCÍCIO 02: Existe um leão no araay animals');
}
...
let addingNumbersFromArray = 0;
const limit = 400;

for (let i = 0; i <= randomNumbers.length; i++) {
  const checkingIfTheSum = addingNumbersFromArray >= limit;

  if (checkingIfTheSum) {
    console.log(
      `EXERCÍCIO 03: A soma ultrapassou ${limit}. Até aqui, o valor atual é ${addingNumbersFromArray}.`
    );
    break;
  }

  addingNumbersFromArray += randomNumbers[i];
}
...
for (let i = 0; i < sentence.length; i++) {
  ...
  const condicinalSentence = word === 'certeza';
  if (condicinalSentence) {
    continue;
  }
  newSentence += `${word} `;
}
console.log('EXERCÍCIO 04: ', newSentence);
...
console.log(`EXERCÍCIO 05: 3 informações sobre o array randomValues:
...
switch (drinkType) {
  ...
  case 'Refrigerante':
    ...
    break;
  case 'Suco':
    drinkMassage = 'Bebida produzida do líquido extraído de frutas';
    break;
  default:
    drinkMassage = 'Bebida desconhecida.';
}
...
const a = 2;
const mesagemNumber = 'O valor de "a" é '
...
switch (a) {
  case 0:
    console.log(`EXERCÍCIO 07: ${mesagemNumber} ${a}`);
    break;
  case 1:
    console.log(`EXERCÍCIO 07: ${mesagemNumber} ${a}`);
    break;
  default:
    console.log(`EXERCÍCIO 07: ${mesagemNumber} qualquer número, exceto 0, 1`);
}
