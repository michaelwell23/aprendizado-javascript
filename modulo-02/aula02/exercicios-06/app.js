...
if (fruits.includes('abacaxi')) {
  console.log('EXERCÍCIO 01: A string "abacaxi" existe no array fruits. ');
} else if (fruits.includes('pera')) {
  console.log('EXERCÍCIO 01: A string "pera" existe no array fruits.');
} else {
  console.log('EXERCÍCIO 01: Nem pera nem abacaxi existem no array "fruits"');
}
...
*/
const currentTime = '9';
const isMornig = currentTime >= 6 && currentTime <= 11;
const isAfternoon = currentTime >= 12 && currentTime <= 17;

if (isMornig) {
  console.log('EXERCICIO 02: Bom dia!');
} else if (isAfternoon) {
  console.log('EXERCICIO 02: Boa tarde!');
} else {
  console.log('EXERCICIO 02: Bom noite!!');
}
...
const myAge = 32;
let underAge7 = myAge <= 7;
let over65yearsOld = myAge >= 65;

if (underAge7 || over65yearsOld) {
  console.log('EXERCICIO 03: Para você, a entrada é grátis!');
} else {
  console.log('EXERCICIO 03: A entrada é R$ 30,00');
}
...
for (let i = 0; i < numbers.length; i++) {
  ...
  const numbersInteractionBetween11and90 = number >= 11 && number <= 90;

  if (numbersInteractionBetween11and90) {
    numbersBetween11and90.push(numbers[i]);
  }
}
console.log('EXERCICIO 04 ', numbersBetween11and90);
...
let booleanAmounts = 0;
let numberAmounts = 0;
let stringsAmounts = 0;
...
console.log(
  `EXERCÍCIO 06: O crazyArray tem ${booleanAmounts} booleans, ${numberAmounts} números e ${stringsAmounts} strings."`
);
/*
  06
...
const generatingOddArrays = [];
const generatingEvenArrays = [];

for (let i = 0; i < randomNumbers.length; i++) {
  const number = randomNumbers[i]
  let evaluatingRandomNumbers = number % 2 !== 0;

  if (evaluatingRandomNumbers) {
    generatingOddArrays.push(number);
  } else {
    generatingEvenArrays.push(number);
  }
}

const oddNumbers = generatingOddArrays.join(', ').replace(', 3', ' e 3');
const pairNumbers = generatingEvenArrays.join(', ').replace(', 5', ' e 5');

console.log(
  `EXERCÍCIO 07: Numeros ímpares: ${oddNumbers}  Números pares: ${pairNumbers}`
);
