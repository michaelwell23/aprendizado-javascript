...
console.log(`EXERCÍCIO 01:, ${name} é um gato ${color} de ${age} anos`);
...
const randomNumbersReverse = randomNumbers.reverse()
console.log('EXERCÍCIO 03', randomNumbersReverse) 
...
const fistItemRemoved =  crazyArray.shift();
console.log('EXERCÍCIO 04',crazyArray);
...
const lookingForDog = dogs.find(dog => dog.name === 'Zequinha');
console.log('EXERCÍCIO 05', lookingForDog);
...
console.log('EXERCÍCIO 06:', title)
...
const referenceSecondaryTitle = document.querySelectorAll('.secondary-title');
console.log('EXERCÍCIO 07:', referenceSecondaryTitle)