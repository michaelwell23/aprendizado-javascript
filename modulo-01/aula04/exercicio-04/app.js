...
*/
const my3FavoriteTVShows = ['Jack Reacher', 'Dexter', 'O Mentalista'];
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ').replace(', O', ' e O')}`
console.log('EXERCICIO 01:', sentence)
...
02 - Comente o console.log() acima e:
  - Exiba no console um boolean indicando se o array de séries que você criou  
    possui 3 itens.
*/
console.log('EXERCICIO 02:', my3FavoriteTVShows.length === 3)
...
console.log('EXERCICIO 03:', isRandomTVShowIncluded)
...
console.log('EXERCICIO 04:', typeSentence)
...
console.log('EXERCICIO 05:', `A string que a "typeSentence" armazena tem mais de ${numberToCheck} caracteres? ${String(typeSentence.length > numberToCheck).replace('t', 'T')}`)
...
console.log('EXERCICIO 06:', `Todos os ${falsyValues.length} itens do array "falsyValues" são falsy. Inclusive o ${falsyValues[2]}` )
...
console.log('EXERCICIO 07:', crazyConversion, "O resultado é 1 e por ser um numero truthy a conversão da true.")
...
console.log(`EXERCICIO 08: A soma entre o  1º e o 3º item de "ages" é menor ou igual a 92. Essa afirmação é: ${agesSum <= 92}.`)
...
console.log('EXERCICIO 09:', isNotAString)
...
console.log('EXERCICIO 10:', evenNumbers.indexOf(8) !== -1)