...
console.log('EXERCÍCIOS 03:',brazilianFoods)
...
console.log('EXERCÍCIOS 04:', brazilianFoods[1]);
...
console.log('EXERCÍCIOS 05:', foodsInfo)
...
console.log('EXERCÍCIOS 06:', dogNames)
...
console.log('EXERCÍCIOS 07:', dogNames.join(', '))
...
dogNames.pop();
console.log('EXERCÍCIOS 08:', dogNames[dogNames.length - 1]);
/*
...
*/
dogNames.push('Nina');
const iniciais = `${dogNames[0][0]}${dogNames[1][0]}${dogNames[2][0]}${dogNames[3][0]}`

console.log('EXERCÍCIOS 09:', iniciais)
...
console.log('EXERCÍCIOS 10', iniciais.toLowerCase())
/*
...
console.log(`EXERCÍCIOS 11: A ${dessert} é um doce à base de coco, tradicional na América Latina e em Angola.`)
/*
...
addNumbers[1] += 4
console.log('EXERCÍCIOS 12:',addNumbers[1] ** 3);
