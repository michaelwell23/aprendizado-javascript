...
*/
const myObj = { name: 'Corinthians', yearsFoundations: 1910 };
...
console.log('EXERCÍCIO 01: ', getObjectFromLocalstorage('myKey'));
...
*/
const inputValue = document.querySelector('[data-js="input"]');
...
const searchAlbumExists = albums.some(album => album.id === searchAlbum.id)

if (searchAlbumExists) {
...
console.log('EXERCÍCIO 05: ', obj, obCopy)
