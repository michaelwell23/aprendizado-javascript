...
const logDataGithub = async(username) => console.log(await getDataGithub(username))
logDataGithub('michaelwell23');
...
const divisorBy2or3 = numbers.filter(number => number % 2 === 0 || number % 3 === 0)

console.log('EXERCÍCIO 02:', divisorBy2or3)
...
/*
  ...
  - Exemplos de nomes na "língua do 'P'":
    ...
    - Rafaela => "PRaPfaPePla".
*/
const syllablesOfMyName = ['mi', 'ch', 'ael'];
const syllablesOfMyName2 = ['Ga', 'Bri', 'ella'];
const myNameLanguageOfTheP = (name) => name.reduce((acc, syllable) => `${acc}P${syllable}`, '')

console.log('EXERCÍCIO 03', myNameLanguageOfTheP(syllablesOfMyName2))
...
*/
const name = 'Michael';
const positionLetterName = name =>  name
  .split('')
  .forEach((item, index) => {
    console.log(`EXERCÍCIO 04: "${item}" é a ${index + 1}ª letra do meu nome.`)
})

positionLetterName(name);
...
console.log('EXERCÍCIO 05:', Object.keys(myObject))
...
const countingRepeatedNumber = (array, value) => array.reduce((acc, item) => value === item ? acc + 1 : acc, 0)

console.log('EXERCÍCIO 06:', countingRepeatedNumber(scores, 100))
...
console.log('EXERCÍCIO 07:', filter([1, 2, 3], item => item)) 
console.log('EXERCÍCIO 07:', filter([0, 1, 2], item => item)) 
console.log('EXERCÍCIO 07:', filter([1, 2, 3], item => item < 2)) 
console.log('EXERCÍCIO 07:', filter([1, 2, 3, 5], (item, index) => item === index + 1)) 
console.log('EXERCÍCIO 07:', filter([1, 2, 3, 2, 1, 5], (item, index, array) => 
