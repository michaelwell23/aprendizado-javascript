...
best2019Movies.forEach(movie => {
  console.log(`EXERCÍCIO 01: ${movie.title}, dirigido por ${movie.directedBy}`);
})
console.log(' ')
/*
  02
...
const youtubeUser = {
  ...
  InformationRecentVideos(){
    console.log( `EXERCICIO 02: Vídeos recentes de ${this.name}:`)
...
youtubeUser.InformationRecentVideos();
console.log(' ')
...
console.log(`EXERCÍCIO 04: ${Math.ceil(firstNumber)}`)
...
console.log(`EXERCÍCIO 05: ${Math.round(secondNumber)}`)
...
console.log(`EXERCÍCIO 06: ${Math.floor(thirdNumber)}`)
...
console.log(`EXERCÍCIO 07: ${Math.trunc(fourthNumber)}`)
...
console.log(`EXERCÍCIO: ${Math.round(randomNumber * 11)}`)
