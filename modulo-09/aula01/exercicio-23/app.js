...
*/
const myString = '    JS      '
console.log('EXERCÍCIO 01:', myString.trim());
...
const peopleClone = people.map((item) => ({
  firstName: item.firstName, 
  lastName: item.lastName, 
  score: item.score
}))
peopleClone.sort((item2, item1) => item2.score - item1.score)
console.log('EXERCÍCIO 02:', peopleClone);
...
const animalsClone = animals.filter((item => item.length === 3));
console.log('EXERCÍCIO 03:', animalsClone);
...
*/
const numbersOfLettersInAnimalsArray = animals.map(item => item.length);
console.log('EXERCÍCIO 04:', numbersOfLettersInAnimalsArray);
...
const friendsNearMe = friends.map((item) => ({ 
  id: item.id,
  name: item.name,
  nearMe: item.nearMe,
})).filter(friends => friends.nearMe === true);
console.log('EXERCÍCIO 05:', friendsNearMe);
...
console.log('EXERCÍCIO 06', sumOdd);
...
console.log('EXERCÍCIO 07:', populationSum);