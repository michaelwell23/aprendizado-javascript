...
let Silvia = Object.create(Car);
let Supra = Object.create(Car);

Supra.color = 'Cinza';
Silvia.color = 'Branco';

console.log('EXERCÍCIO 01', Silvia.getColor('roxo'), Supra.getColor('Cinza'));
...
console.log('EXERCÍCIO 02:', getSummary.call(movie));
// console.log('EXERCÍCIO 02:', getSummary.apply(movie))
...
*/
const concateneteZero = (unit) => (unit < 10 ? `0${unit}` : unit);
const formatTimeUnits = (units) => units.map(concateneteZero);
