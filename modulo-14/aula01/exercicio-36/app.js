...
const myNameUpperCase = [myName[0].toUpperCase(), ...myName.slice(1)].join('')
console.log('EXERCÍCIO 02:', myNameUpperCase);
...
const showItem = () => {
  ...
  images[itemVisible].classList.add('carousel__item--visible')
}

nextButton.addEventListener('click', () => {
  itemVisible = itemVisible >= images.length - 1 ? 0 : itemVisible + 1
